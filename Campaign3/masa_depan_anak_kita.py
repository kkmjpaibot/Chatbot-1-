    ...
    async def process_message(self, user_id: str, message: Union[str, dict], ws: Any = None, user_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if state.current_step == "welcome":
                ...
                if is_button_click or self._is_affirmative(message):
                    ...
                    # Update the response with the explanation and buttons
                    response = {
                    ...
                    # User doesn't want to continue, end conversation
                    state.current_step = "end"
                    return {
                        "type": "message",
                        "content": "Thank you for your interest. Feel free to come back if you have any questions about education savings!",
                        "campaign_data": state.user_data,
                        "next_step": "end"
                    }
                else:
            ...
            # Handle response to initial welcome
                ...
                if self._is_affirmative(message) or message.lower() == 'yes':
                    ...
                    return {
                        "type": "message",
                        "content": "No problem! If you have any questions about education savings in the future, feel free to ask. Have a great day!",
                        "campaign_data": state.user_data,
                        "next_step": "end"
                    }
            ...
            # Handle response to estimation question
                ...
                if self._is_affirmative(message) or "estimate" in message.lower() or message.lower() == "yes":
                    ...
                    # User doesn't want to proceed with estimation
                    state.current_step = "end"
                    return {
                        "type": "message",
                        "content": "No problem! If you have any questions about education savings in the future, feel free to ask. Have a great day!",
            ...
            # Handle custom saving amount input
                ...
                try:
                    ...
                    # Return the response for calculation
                    return {
                        "type": "message",
                        "content": f"Great! I'll calculate the projected education fund with a monthly saving of RM {amount}.",
                        "campaign_data": state.user_data,
                        "next_step": "calculate_results"
                    }
            ...
            # Handle completion and restart
                ...
                if message.lower() == "contact_agent":
                    ...
                    return {
                        "type": "buttons",
                        "content": "Thank you for using Masa Depan Anak Kita. How else can we assist you today?",
                        "campaign_data": state.user_data,
